...
async def main():
    ...
    nickname = await input("Enter the chat", required=True,placeholder="Your Name",validate=lambda n:"This nickname is already in use!" if n in online_users or n == '📢' else None)
    ...
    while True:
        ...
        ], validate = lambda m: ('msg', "Type text here!") if m["cmd"] == "Send" and not m['msg'] else None)
